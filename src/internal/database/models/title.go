...
type Title struct {
	...
	DivisionID int64  `gorm:"column:division_id;index:idx_titles_division_id" json:"division_id"`
	...
	// Relations
	HasDivision  *Division  `gorm:"foreignKey:DivisionID;references:ID;constraint:OnDelete:SET NULL;" json:"has_division"`
