...
func RunBenchmarkSopSQL(cn *container.AppContainer) fiber.Handler {
	return func(c *fiber.Ctx) error {
		...
		result := helper.RunVegetaLoadTest("GET", targetURL, "SQL - Get All SOPs", 5, 50)
...
func RunBenchmarkSopGraph(cn *container.AppContainer) fiber.Handler {
	return func(c *fiber.Ctx) error {
		...
		result := helper.RunVegetaLoadTest("GET", targetURL, "Graph - Get All SOPs", 5, 50)
...
func RunBenchmarkSopJobSQL(cn *container.AppContainer) fiber.Handler {
	return func(c *fiber.Ctx) error {
		...
		_ = filter
		result := helper.RunVegetaLoadTest("GET", targetURL, "SQL - Complex SOP Jobs", 5, 20)
...
func RunBenchmarkSopJobGraph(cn *container.AppContainer) fiber.Handler {
	return func(c *fiber.Ctx) error {
		...
		_ = filter
		result := helper.RunVegetaLoadTest("GET", targetURL, "Graph - Complex SOP Jobs", 5, 20)
...
func RunBenchmarkSopJobTitleSQL(cn *container.AppContainer) fiber.Handler {
	return func(c *fiber.Ctx) error {
		...
		result := helper.RunVegetaLoadTest("GET", targetURL, "SQL - SOP Jobs by Title", 5, 20)
...
func RunBenchmarkSopJobTitleGraph(cn *container.AppContainer) fiber.Handler {
	return func(c *fiber.Ctx) error {
		...
		result := helper.RunVegetaLoadTest("GET", targetURL, "Graph - SOP Jobs by Title", 5, 20)
...
func RunBenchmarkSopJobDivisionSQL(cn *container.AppContainer) fiber.Handler {
	return func(c *fiber.Ctx) error {
		...
		result := helper.RunVegetaLoadTest("GET", targetURL, "SQL - SOP Jobs by Division", 5, 20)
...
func RunBenchmarkSopJobDivisionGraph(cn *container.AppContainer) fiber.Handler {
	return func(c *fiber.Ctx) error {
		...
		result := helper.RunVegetaLoadTest("GET", targetURL, "Graph - SOP Jobs by Division", 5, 20)
...
func RunBenchmarkSopJobDivisionTitleSQL(cn *container.AppContainer) fiber.Handler {
	return func(c *fiber.Ctx) error {
		...
		result := helper.RunVegetaLoadTest("GET", targetURL, "SQL - SOP Jobs by Division & Title", 5, 20)
...
func RunBenchmarkSopJobDivisionTitleGraph(cn *container.AppContainer) fiber.Handler {
	return func(c *fiber.Ctx) error {
		...
		result := helper.RunVegetaLoadTest("GET", targetURL, "Graph - SOP Jobs by Division & Title", 5, 20)
...
func RunBenchmarkSopJobReferenceDivisionSQL(cn *container.AppContainer) fiber.Handler {
	return func(c *fiber.Ctx) error {
		...
		result := helper.RunVegetaLoadTest("GET", targetURL, "SQL - SOP Jobs by Reference Division", 5, 20)
...
func RunBenchmarkSopJobReferenceDivisionGraph(cn *container.AppContainer) fiber.Handler {
	return func(c *fiber.Ctx) error {
		...
		result := helper.RunVegetaLoadTest("GET", targetURL, "Graph - SOP Jobs by Reference Division", 5, 20)
...
func RunBenchmarkSopJobDivisionTitlePublishedSQL(cn *container.AppContainer) fiber.Handler {
	return func(c *fiber.Ctx) error {
		...
		result := helper.RunVegetaLoadTest("GET", targetURL, "SQL - SOP Jobs by Division/Title/Published", 5, 20)
...
func RunBenchmarkSopJobDivisionTitlePublishedGraph(cn *container.AppContainer) fiber.Handler {
	return func(c *fiber.Ctx) error {
		...
		result := helper.RunVegetaLoadTest("GET", targetURL, "Graph - SOP Jobs by Division/Title/Published", 5, 20)
